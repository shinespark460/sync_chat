...
import no_archive from "../../assets/images/no_archive.png"
const ArchiveTab = () => {
  ...
  return (
    <div className=" w-full  h-screen overflow-y-auto flex flex-col py-4 md:border-r ">
      ...
      <div className="px-4">
        <div className="relative my-3">
          ...
          <input
            ...
            value={input}
            className="w-full input pl-9 pr-3 py-2.5 border outline-none focus:ring-1 focus:ring-base-300 transition"
          />
        </div>
      </div>
      ...
      {/* Chat list */}
      {
        searchedUsers.length > 0 ? (<div className="flex flex-col">
          ...
          <img src={no_archive} alt="No Archive" className="w-48 h-48 object-contain"/>
          <h2 className="text-2xl font-semibold">No Archives</h2>
          </div>
        )
      }
