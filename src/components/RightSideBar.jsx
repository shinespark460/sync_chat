  ...
  return selectedUser && (
    <div className={` bg-[#818582]/10 overflow-y-auto h-full relative p-5 rounded-lg ${selectedUser ? 'max-md:hidden' : ""}`}>
      <div className='flex flex-col items-center gap-3'>
        ...
        <h1 className='px-2 text-xl text-white text-center flex flex-row  items-center gap-2'> <p className='w-2 h-2 bg-green-500 rounded-full '> </p>{selectedUser.fullName}</h1>
     ...
     <button  className='bottom-2 text-white font-medium  absolute left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-400 to-violet-600 border-none text-sm  py-2 px-20 rounded-full cursor-pointer'>Logout
